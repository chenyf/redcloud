    ...
    public static function getInstance($db_config='') {
		...
		if(!isset($_instance[$guid])){
			...
			$_instance[$guid]	=	$obj->factory($db_config);
                ...
                $_instance[$guid]->_guid = $guid;
                //$_instance[$guid]->webCodeObj = new WebCode();
...
//    }
    ...
    public function processSql(&$sql){
        $from = 'think=>['.$this->config['database']."]";
//        $sql = $this->webCodeObj->processSql($sql, $from);
    }
