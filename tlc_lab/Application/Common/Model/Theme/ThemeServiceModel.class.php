...
use Common\Model\System\SettingModel;

class ThemeServiceModel extends BaseModel
{
    ...
    {
        return $this->createDao('Theme.ThemeConfigModel');
//        return $this->createDao('GracefulTheme:GracefulTheme.ThemeConfigModel');
    }
