...
use Common\Model\Order\OrderRefundProcessor\OrderRefundProcessorFactory;

class OrderRefundController extends \Home\Controller\BaseController
{
    public function refundAction(Request $request , $id)
    {
        ...
        return $this->render('OrderRefund:refund-modal', array(
            'target' => $target,
