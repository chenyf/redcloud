define(function(require, exports, module) {
    ...
    var DocumentPlayer = Widget.extend({
        attrs: {
            swfFileUrl:'',
            pdfFileUrl:'',
            swfPlayerUrl:'../../bundles/web/js/controller/swf/redcloudViewer.swf',
            swfPlayerWidth:'100%',
            swfPlayerheight:'100%'
        },
        ...
        initPDFJSViewer: function(thiz){
            self=this;
            $("html").attr('dir','ltr');
            $('#viewerIframe').attr('src', window.site_url+'/Public/assets/libs/pdfjs/view.html#'+self.attrs.pdfFileUrl.value);
        },
