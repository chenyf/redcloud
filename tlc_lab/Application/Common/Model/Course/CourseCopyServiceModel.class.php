...
class CourseCopyServiceModel extends BaseModel{
    
    public function getUploadFileDao(){
        return $this->createDao("File.UploadFile");
    }
    ...
    public function getTestpaperItemDao(){
        return $this->createDao("Testpaper.TestpaperItem");
    }

    public function getTestpaperDao(){
        return $this->createDao("Testpaper.Testpaper");
    }
    ...
    private function getHomeworkDao(){
        return $this->createDao("Homework.Homework");
    }

    private function getHomeworkItemDao()
    {
        return $this->createDao("Homework.HomeworkItem");
    }

    private function getExerciseDao()
    {
        return $this->createDao("Homework.Exercise");
    }
    ...
    public function copyCourse($course){
        ...
        $fields['status'] = 'draft';
        $fields['createdTime'] = time();
        return $this->getCourseDao()->addCourse($this->getCourseService()->courseSerializeSerialize($fields));
    }
