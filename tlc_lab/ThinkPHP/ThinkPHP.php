...
defined('WEB_ENV_CONF_PATH') or define('WEB_ENV_CONF_PATH', realpath(COMMON_PATH).'/' . 'Conf/WebEnvConf/');
...
//defined('LOG_PATH')     or define('LOG_PATH',       SITE_PATH.'/Logs/'); // 应用日志目录
...
#qzw 2015-09-21
defined('SCHEME')       or define('SCHEME', isset($_SERVER['HTTPS']) && $_SERVER['HTTPS']=='on' ? 'https' : 'http');
defined('SITE_URL')     or define('SITE_URL', SCHEME .'://' . $_SERVER['HTTP_HOST']);
...
defined('IS_CLI') or define('IS_CLI',PHP_SAPI=='cli'? 1   :   0); #qzw 2015-09-21
