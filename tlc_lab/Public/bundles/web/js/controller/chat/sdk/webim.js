...
(function(webim) {
	var WEB_IM_SRV_HOST = "https://webim.tim.qq.com";
        ...
        var WEB_IM_SDK_VERSION='v1.2';//web im sdk版本号
	...
	Msg.Elem.Sound = function(uuid,second,size,senderId,downUrl) {
		...
		//return '<div id="div_'+this.uuid+'"><a href="#'+this.downUrl+'" title="点击播放语音" onclick="soundClick(this)" ><i class="glyphicon glyphicon-volume-up">&nbsp;时长:'+this.second+'秒</i></a></div>';
		...
		this.syncGroupMsgs = function(options,cbOk, cbErr) {
			...
			proto_getGroupMsgs(opts,function(resp) {
                ...
                var handlerGroupMsg=function (group_id,msgInfo){
	                ...
	                msg = $.extend(msg,{groupInfo:msgInfo.GroupInfo});
					if (MsgStore.addMsg(msg)) {
                                                //更新我的群最大的消息seq
