...
class PluginUtil extends BaseModel
{
	...
	public static function refreshMetaFile($apps)
    {
        ...
        $dataDirectory = realpath(getParameter('kernel.root_dir') . '/data/');
    ...
    {
        $pluginRootDirectory = realpath(getParameter('kernel.root_dir') . '/../plugins');
        ...
        $pluginRouteFilePath = getParameter('kernel.root_dir') . '/config/routing_plugins.yml';
