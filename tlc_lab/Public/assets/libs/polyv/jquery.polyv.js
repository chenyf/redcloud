define(function(require, exports, module) {
	...
	(function ($,Notify) {
		...
		function ResumableUpload (file, options) {
			ResumableUpload.prototype.status = true;
			// The file to upload
			this.file = file;
		...
		ResumableUpload.prototype._post = function () {
			...
			var options = {
				...
				data : {title : self.options.title, ext : self.options.ext, desc : self.options.desc,cataid:self.options.cataid},
				headers : {
		...
		ResumableUpload.prototype.stop = function () {
			if ( this._jqXHR ) {
				ResumableUpload.prototype.status = false;
				this._jqXHR.abort();
			}
		};
