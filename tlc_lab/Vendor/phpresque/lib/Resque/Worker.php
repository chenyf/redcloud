...
class Resque_Worker
{
	...
	*/
	...
	{       
                $flag = getenv("FLAG");
//                $webSiteCode = !empty($webSiteCode) ? $webSiteCode:C("WEBSITE_CODE");
//                $processTitle = '['.$webSiteCode.']_resque-' . Resque::VERSION . ': ' . $status;    
                $pfx = $flag ? '['.$flag.']' : '';
            $processTitle = $pfx.' resque-' . Resque::VERSION . ': ' . $status;    
