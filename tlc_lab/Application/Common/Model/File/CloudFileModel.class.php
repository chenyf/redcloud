...
//        $uploadFile['canDownload'] = empty($uploadFile['canDownload']) ? 0 : 1;
    ...
    private function getVideoWatermarkImages()
    {
        ...
        $videoWatermarkImage = $this->getEnvVariable('baseUrl').getParameter('redcloud.upload.public_url_path')."/".$setting['video_embed_watermark_image'];
    ...
    {
        $diskDirectory = getParameter('redcloud.disk.local_directory');
