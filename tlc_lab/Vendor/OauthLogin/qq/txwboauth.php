...
class QqWeiboClient
{
	...
	//2.t/add 发表一条微博
	function t_add($content='',$longitude='',$latitude='',$format='json')
	{
	...
	//4.t/re_add 转播一条微博
	function t_re_add($reid,$content='',$longitude='',$latitude='',$format='json')
	{
		$param['content'] =$content;
		$param['reid'] =$reid;
		$param['format']=$format;
	...
	//5.t/reply 回复一条微博
	function t_reply($reid,$content='',$longitude='',$latitude='',$format='json')
	{
		$param['content'] =$content;
		$param['reid'] =$reid;
		$param['format']=$format;
	...
	function t_add_pic($content='',$pic_data='',$longitude='',$latitude='',$format='json')
	{
		$param['format']=$format;
		$param['pic']=$pic_data;
		$param['content']=$content;
	...
	//9.t/comment 点评一条微博
	function t_comment($reid,$content='',$longitude='',$latitude='',$format='json')
	{
		$param['content'] =$content;
		$param['reid'] =$reid;
		$param['format']=$format;
	...
	//1.private/add 发一条私信
	function pm_add($name,$content='',$longitude='',$latitude='',$format='json')
	{
		$param['content'] =$content;
		$param['name'] =$name;
		$param['format']=$format;
