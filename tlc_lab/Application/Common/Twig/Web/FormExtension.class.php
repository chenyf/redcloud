...
//        $this->renderer->setEnvironment($environment);
    ...
    public function getFunctions()
    {
        return array(
            ...
            new \Twig_SimpleFunction('form_widget', null, array('node_class' => 'Common\Twig\Node\SearchAndRenderBlockNode', 'is_safe' => array('html'))),
    ...
    {
        return generateCsrfToken($intention);
