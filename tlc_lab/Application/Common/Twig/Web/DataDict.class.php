	...
	private static $dict = array(
		...
		'orderStatus:html' => array(
			...
			'cancelled' => '<span class="text-muted">已关闭</span>',
                ...
                'cashStatus:html'=>array(
                    '0' => '<span class="label label-danger">未提现</span>',
		    '1' => '<span class="label label-success">提现中</span>',	
	            '2' => '<span class="text-warning">已提现</span>',
                ),
                'schoolOrdersStatus:html'=>array(
                    '0' => '<span class="label label-danger">申请提现中</span>',
		    '1' => '<span class="label label-success">提现通过</span>',	
	            '2' => '<span class="text-warning">提现未通过</span>',
                ),
                 'cashTeacherStatus:html'=>array(
                    '0' => '<span class="label label-danger">申请结算中</span>',
		    '1' => '<span class="label label-success">结算通过</span>',	
	            '2' => '<span class="text-warning">结算未通过</span>',
                ),
                 'schoolOrdersType:html'=>array(
                    '0' => '<span class="label label-danger">本校课程</span>',
		    '1' => '<span class="label label-success">公有课</span>',	
                ),
		'refundStatus' => array(
			'created'  => '已申请',
			'success' => '退款成功',
