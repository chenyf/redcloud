<?php
namespace Common\Model\CloudPlatform\Client;

use Common\Model\CloudPlatform\Client\AppClient;
use Common\Lib\System;
//use Topxia\System;

class WyzcAppClient implements AppClient
{

    protected $userAgent = 'Open redcloud App Client 1.0';

    protected $connectTimeout = 5;

    protected $timeout = 5;

    private $apiUrl = 'http://open.redcloud.com/app_api';
