    ...
    var rules = [
        ...
        [
            ...
            function(options, commit) {
                var element = options.element,
                    ...
                    var type = options.type ? options.type : (element.data('type') ? element.data('type') : null);
                if(type=="addUser"){
        ...
        [
            ...
            function(options, commit) {
                var element = options.element,
                    url = options.url ? options.url : (element.data('url') ? element.data('url') : null);
                    var mobile = $(options.mobileSel).size() ? $(options.mobileSel).val() : '';
        ...
        [
            ...
            function(options, commit) {
                var element = options.element,
                    url = options.url ? options.url : (element.data('url') ? element.data('url') : null);
                    var email = $(options.emailSel).size() ? $(options.emailSel).val() : '';
                $.get(url, {value:element.val(), email: email}, function(response) {
                    commit(response.success, response.message);
                }, 'json');
            }
        ],
